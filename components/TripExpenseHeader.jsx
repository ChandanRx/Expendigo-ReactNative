...
const TripExpenseHeader = () => {
    ...
    return (
        <View style={{ paddingTop: ios ? top : top + 15 }} className='justify-between px-5 bg-indigo-950 pb-6 rounded-b-2xl shadow'>
            ...
            <View>
            <Text style={{ fontSize: hp(3) }} className='font-semibold text-white text-center'>{city}</Text>
            <Text className='font-medium text-white text-center'>{state}</Text>
            </View>
...
export default TripExpenseHeader;